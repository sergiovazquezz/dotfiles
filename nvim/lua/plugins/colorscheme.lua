return {
  ...
  --         -- Force all tabline/bufferline related highlights to be transparent
  ...
  --       },
  --       on_colors = function(colors)
  --         colors.bg = transparent and colors.none
  --         colors.bg_dark = transparent and colors.none
  --         colors.bg_float = transparent and colors.none
  --         -- colors.bg_highlight = bg_highlight
  --         -- colors.bg_popup = bg_dark
  --         -- colors.bg_search = bg_search
  --         colors.bg_sidebar = transparent and colors.none
